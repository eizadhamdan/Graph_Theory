package Bridges_and_Articulation_Points;
...
public class BridgesAdjacencyListIterative {
    ...
    // The returned list is always of even length and indexes (2*i, 2*i+1) form a pair.
    // For example, nodes are indexes (0, 1) are a pair, (2, 3) are another pair, etc...
