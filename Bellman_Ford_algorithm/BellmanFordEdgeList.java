...
public class BellmanFordEdgeList {
    ...
    public static double[] bellmanFord(Edge[] edges, int V, int start) {
        ...
        // Only in the worst case does it take V-1 iterations for the Bellman-Ford algorithm to complete.
        // Another stopping condition is when we're unable to relax an edge, this means we have reached the optimal solution early.
