...
public class BellmanFordAdjacencyMatrix {
    ...
    public void solve() {
        ...
        // Initialize prev array which will allows for shortest path reconstruction after the algorithm has terminated.
        prev = new Integer[n];
    ...
    public static void main(String[] args) {
        ...
        // Setup completely disconnected graph with the distance from a node to itself to be zero.
        for (int i = 0; i < n; i++) {
