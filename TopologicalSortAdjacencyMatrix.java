...
public class TopologicalSortAdjacencyMatrix {
    ...
    // Performs the topological sort and returns the indexes of the nodes in topological order
    ...
    // Given an adjacency matrix with double valued edge weights this method finds the shortest path from a start node to all other nodes in the graph.
    ...
    public static void main(String[] args) {
        ...
        // Finds the shortest path from 0 to 6 prints Infinity (6 is not reachable!)
