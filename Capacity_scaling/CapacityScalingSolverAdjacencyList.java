...
public class CapacityScalingSolverAdjacencyList extends NetworkFlowSolverBase {
    ...
    /*
     * Creates an instance of a flow network solver. Use the {@link #addEdge(int, int, int)} method to add edges to the graph.
     *
    ...
    public void solve() {
        ...
        // Repeatedly find augmenting paths from source to sink using only edges with a remaining capacity >= delta. 
        // Half delta every time we become unable to find an augmenting path from source to sink until the graph is saturated.
    ...
    private static void testSmallFlowGraph() {
        ...
        System.out.print("The maximum capacity is: ");
