package Tarjans_algorithm;

/*
 * Implementation of Tarjan's SCC algorithm for a directed graph.
...
class TarjanAdjacencyMatrix {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(
                "Strongly connected component count: " + sccs.countStronglyConnectedComponents());
        System.out.println(
