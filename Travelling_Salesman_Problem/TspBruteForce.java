...
/*
 * Solving the traveling salesman problem using a brute force approach.
...
public class TspBruteForce {
    ...
    // Given an n x n complete graph represented as an adjacency matrix this method finds the best tour that visits all
    ...
    // Recommended usage is to start with the smallest permutations and use a do while loop to generate each successive permutations.
