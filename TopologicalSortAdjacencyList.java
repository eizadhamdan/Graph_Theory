...
public class TopologicalSortAdjacencyList {
    ...
    // Helper method that performs a depth first search on the graph to give us the topological ordering we want.
    // Instead of maintaining a stack of the nodes we see we simply place them inside the ordering array in reverse order for simplicity.
    ...
    // The input to this function is an adjacency list for a graph and the number of nodes in the graph.
    ...
    // A useful application of the topological sort is to find the shortest path between two nodes in a Directed Acyclic Graph (DAG).
